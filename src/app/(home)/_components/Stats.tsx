export default function Stats() {
  return (
    <section className="w-full max-w-[1100px] mx-auto px-6 mt-16 md:mt-24 mb-10 relative z-10">
      <div className="rounded-[32px] py-12 px-6 sm:px-10 grid grid-cols-2 md:grid-cols-3 gap-y-12 gap-x-4 md:gap-12 bg-surface border backdrop-blur-md relative overflow-hidden shadow-[0_0_50px_--alpha(var(--color-accent)/5%)]">
