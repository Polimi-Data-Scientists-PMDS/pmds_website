  ...
  return (
    <div className="flex flex-col min-h-screen pt-24 pb-20 relative z-10 w-full">
      <div className="max-w-[800px] mx-auto px-6 w-full">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4 tracking-tight">Legal & Privacy</h1>
        ...
        {/* Association Details */}
        <div className="mb-12 p-5 rounded-xl bg-surface border text-sm text-muted space-y-1">
          <p className="text-foreground font-semibold">Associazione Polimi Data Scientists (PMDS)</p>
          <p>Student association recognized by Politecnico di Milano</p>
          <p>Codice Fiscale: <span className="text-muted font-mono">97859030153</span></p>
          <p>Email: <a href="mailto:info@polimidatascientists.it" className="text-accent hover:underline">info@polimidatascientists.it</a></p>
        </div>
        ...
        <div className="space-y-16">
          ...
          <section id="terms" className="scroll-mt-32">
            ...
            <div className="space-y-6 text-muted text-sm leading-relaxed">
              <div>
                <h3 className="text-foreground font-semibold mb-2">1. Nature of the Association & Fee</h3>
                <p>
              ...
              <div>
                <h3 className="text-foreground font-semibold mb-2">2. Eligibility</h3>
                <p>
                ...
                <p className="mt-2">
                  Registration requires an official university email address (<code className="text-muted">@mail.polimi.it</code> or <code className="text-muted">@polimi.it</code>). External individuals, professionals, and students from other universities cannot register as members. Those wishing to support our initiatives may do so through <a href="https://donate.stripe.com/aFadR1fD69lpdRV9F64sE00" target="_blank" rel="noopener noreferrer" className="text-accent underline hover:text-foreground transition-colors">voluntary donations</a>.
                </p>
              </div>

              <div>
                <h3 className="text-foreground font-semibold mb-2">3. Membership Tiers & Board Approval</h3>
                <p>
                  PMDS offers three membership levels:
                </p>
                <ul className="list-disc pl-5 mt-2 space-y-1.5">
                  <li>
                    <strong className="text-muted">Standard (€6/year):</strong> Supporter tier granting access to open workshops and general community channels.
                  </li>
                  <li>
                    <strong className="text-muted">Premium (€11/year):</strong> Supporter tier granting access to exclusive activities, priority event registration, and a complimentary welcome gadget.
                  </li>
                  <li>
                    <strong className="text-muted">Active (€11/year):</strong> Includes all Premium benefits plus full voting rights in the General Assembly and eligibility to run for the Executive Board. Active members are required to attend assemblies and participate in associative duties (such as approving the annual financial balance).
                  </li>
                </ul>
                <p className="mt-3">
              ...
              <div>
                <h3 className="text-foreground font-semibold mb-2">4. Validity Period & Tranches</h3>
                <p>
              ...
              <div>
                <h3 className="text-foreground font-semibold mb-2">5. Refund Policy (Non-Refundability)</h3>
                <p>
              ...
              <div>
                <h3 className="text-foreground font-semibold mb-2">6. Welcome Gadgets & Physical Items</h3>
                <p>
              ...
              <div>
                <h3 className="text-foreground font-semibold mb-2">7. Tier Switching</h3>
          ...
          <section id="privacy" className="scroll-mt-32">
            ...
            <div className="space-y-6 text-muted text-sm leading-relaxed">
              <div>
                <h3 className="text-foreground font-semibold mb-2">1. Data Controller</h3>
                <p>
                  The Data Controller is <strong>Associazione Polimi Data Scientists</strong>, Codice Fiscale 97859030153. Contact: <a href="mailto:privacy@polimidatascientists.it" className="text-accent hover:underline">privacy@polimidatascientists.it</a>.
                </p>
              </div>

              <div>
                <h3 className="text-foreground font-semibold mb-2">2. Personal Data Collected</h3>
                <p>
                ...
                <ul className="list-disc pl-5 mt-2 space-y-1">
                  ...
                  <li>Date of birth;</li>
                  <li>Institutional email address (<code className="text-muted">@mail.polimi.it</code> or <code className="text-muted">@polimi.it</code>);</li>
              ...
              <div>
                <h3 className="text-foreground font-semibold mb-2">3. Purpose and Legal Basis of Processing</h3>
              ...
              <div>
                <h3 className="text-foreground font-semibold mb-2">4. Payment Processing</h3>
                <p>
                  All payments are processed securely via <strong>Stripe Payments Europe, Ltd.</strong> PMDS never collects, stores, or has access to your credit card details, CVVs, or bank credentials. Payment data is handled directly by Stripe in compliance with PCI-DSS standards. For more details, consult <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="text-accent underline hover:text-foreground transition-colors">Stripe&apos;s Privacy Policy</a>.
                </p>
              </div>

              <div>
                <h3 className="text-foreground font-semibold mb-2">5. Data Sharing and Retention</h3>
                <p>
              ...
              <div>
                <h3 className="text-foreground font-semibold mb-2">7. Cookies</h3>
                <p>
